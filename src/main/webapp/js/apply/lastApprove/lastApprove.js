...
function visitExternal(applyLoanNo) {
	...
	$.ajax({
		url : serverPath + "/lastApprove/visitExternal.htm",
		type : "post",
		data : {
			"requirement" : value,
...
function rollBack(applyLoanNo) {
	...
	$.ajax({
		url : serverPath + "/lastApprove/rollBack.htm",
		type : "post",
		data : {
...
function submit(applyLoanNo) {
	...
	$.ajax({
		url : serverPath + "/lastApprove/submitTaskInfo.htm",
		type : "post",
		data : paramStr,
		dataType : "json",
		success : function(result) {
