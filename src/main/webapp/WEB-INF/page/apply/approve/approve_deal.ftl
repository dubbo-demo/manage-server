...
<script src="${cdnPath}/js/apply/approve/deal_audit.js?v=${VERSION_NO}"></script>
				...
				<div class="control-group span4 ">
					...
					<div class="controls">
						<select class="m-wrap span8"
							...
							<option value="${states['FINISH']}">通过</option>
							<option value="${states['REFUSE']}">拒绝</option>
