...
<div class="page-content">
			...
			<div class="container-fluid">
				<div class="row-fluid">
					<div class="span12">
						<!--页面标题-->
						<h3 class="page-title">回退处理<small></small></h3>
						<!--面包屑导航-->
						<ul class="breadcrumb">
							<li> <i class="icon-home"></i>
								<a href="index.htm">首页</a> <i class="icon-angle-right"></i> </li>
							<li>
			...
			<div class="row-fluid">
				<div class="portlet box red">
					<!-- <div class="portlet-title" >
						<div class="caption">
							<i class="icon-reorder">退回</i>
						</div>
					</div> -->
					<div style="height:1px; width:1px;position: relative; ">
							<img style="position: absolute;width:119px;max-width:119px;" src="${cdnPath}/images/return.png">
					</div>
						...
						<form id="tab" action="#" method="POST"
							...
							<div class="row-fluid">
								<div class="control-group span4 ">
									...
									<div class="controls">
										<input type="text" name="" value="信用贷款" class="m-wrap " />
									</div>
								</div>
								<div class="control-group span4 ">
									<label class="control-label">门店</label>
									<div class="controls">
										<input type="text" name="storeId" value="${reception.storeName!}" class="m-wrap " />
									</div>
								</div>
								<div class="control-group span4 ">
									<label class="control-label">大区</label>
									<div class="controls">
										<input type="text" name="areaId" value="${reception.areaName!}" class="m-wrap " />
										<input type="button" class="btn yellow" onclick="javascript:queryBackFileForm();" value="查看附件" />
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="control-group span4 ">
									...
									<div class="controls">
										<input type="text" name="prodType" id="prodType" value="${reception.prodType!}" 
										data-value="${reception.prodType!}" class="m-wrap " />
									</div>
								</div>
								<div class="control-group span4 ">
									<label class="control-label">贷款期数</label>
									<div class="controls">
										<input type="text" name="loanPeriods" value="${reception.loanPeriods!}" class="m-wrap " />
									</div>
								</div>
								<div class="control-group span4 ">
									<label class="control-label">申请金额</label>
									<div class="controls">
										<input type="text" name="applyMoney" value="${reception.applyMoney!}" class="m-wrap " />
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="control-group span4 ">
									...
									<div class="controls">
										<input type="text" name="applyLoanNo" value="${reception.applyLoanNo!}" class="m-wrap " />
									</div>
								</div>
								<div class="control-group span4 ">
									...
									<div class="controls">
										...
										id="loanUse" data-value="${reception.loanUse!}" class="m-wrap " />
									</div>
								</div>
								<div class="control-group span4 ">
									<label class="control-label">申请时间</label>
									<div class="controls">
										<input type="text" name="createTime" value="${(reception.createTime?string("yyyy-MM-dd"))!}" class="m-wrap " />
									</div>
								</div>
							</div>
							...
							<form id="tab_userinfo" action="#" method="POST"
								...
								<div class="row-fluid">
									<div class="control-group span4 ">
										...
										<div class="controls">
											<input type="text" name="censusAddr" id="censusAddr" value="${userinfo.censusAddr!}" readonly class="m-wrap span9" maxlength="200"/>
							...
							<hr>
							<div style="width:100%;" id="tab_audit" class="form-horizontal">
								<div class="row-fluid">
									<div class="control-group span9">
										<label class="control-label">接待审核</label>
										<div class="controls">
											<input type="text" readonly value="通过" class="m-wrap " />
										</div>
									</div>
								</div>
							...
							<div style="width:100%;" id="tab_audit" class="form-horizontal">
								<div class="row-fluid">
									<div class="control-group span3">
										<label class="control-label">初审审核</label>
										<div class="controls">
											<input type="text" readonly value="回退" class="m-wrap " />
										</div>
									</div>
									<div class="control-group span6 ">
										<label class="control-label">退回原因</label>
										<div class="controls">
											<span class="text" style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;margin-left:0px" title="${(auditLog.backReasonDesc)!}">${(auditLog.backReasonDesc)!}
											</span>
										</div>
									</div>
								...
								<div class="row-fluid">
									<div class="control-group ">
										<label class="control-label">初审意见描述</label>
										<div class="controls">
											<textarea class="span9 m-wrap" rows="3" name="description" maxlength="300">${(auditLog.publicRemark)!}</textarea>
										</div>
									</div>
								</div>
							</div>
						<div class="form-actions" style="text-align:center;">
							<input type="button" class="btn blue" onclick="page_jump('${serverPath}/apply/manage/list.htm?menu_index=1');" data-type="1" 	value="返回" /> &nbsp;&nbsp;
							<input type="button" class="btn blue" onclick="reshareSave();" data-type="1" 	value="重新提交" /> &nbsp;&nbsp;
						</div>
					</div>
				</div>
			</div>
