						...
						<form id="tab_userinfo" action="#" method="POST"
							...
							<div class="row-fluid">
								<div class="control-group span6 ">
									...
									<div class="controls">
										<select name="sex" class="m-wrap large" data-value="${(member.sex)!''}">
								...
								<div class="control-group span6 ">
									...
									<div class="controls">
										<select name="eduCode" class="m-wrap large" data-value="${(member.eduCode)!''}">
											<option value="">请选择</option>
							...
							<div class="row-fluid">
								...
								<div class="control-group span6 ">
									...
									<div class="controls">
										<input type="text" name="nation" value="${(member.nation)!''}" class="m-wrap large" maxlength="20"/>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								...
								<div class="control-group span6 ">
									...
									<div class="controls">
										<input type="text" name="SNSAccount" value="${(member.SNSAccount)!''}" class="m-wrap large" maxlength="50"/>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="control-group span6 ">
									...
									<div class="controls">
										<input type="text" name="censusAddr" id="censusAddr" readonly value="${(member.censusAddr)!'请选择'}" class="m-wrap large" maxlength="200"/>
										<input type="hidden" name="censusProvcode" id="censusProvcode" class="m-wrap large" value="${(member.censusProvcode)!'0'}" />
										<input type="hidden" name="censusCitycode" id="censusCitycode" class="m-wrap large" value="${(member.censusCitycode)!'0'}" />
										<input type="hidden" name="censusTowncode" id="censusTowncode" class="m-wrap large" value="${(member.censusTowncode)!'0'}" />
									</div>
								</div>
								<div class="control-group span6 ">
									<label class="control-label">现住址<span class="required">*</span></label>
									<div class="controls">
										<input type="text" name="liveAddr" id="liveAddr" readonly value="${(member.liveAddr)!'请选择'}" class="m-wrap large" maxlength="200"/>
										<input type="hidden" name="liveProvcode" id="liveProvcode" class="m-wrap large" value="${(member.liveProvcode)!'0'}" />
										<input type="hidden" name="liveCitycode" id="liveCitycode" class="m-wrap large" value="${(member.liveCitycode)!'0'}"/>
										<input type="hidden" name="liveTowncode" id="liveTowncode" class="m-wrap large" value="${(member.liveTowncode)!'0'}" />
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="control-group span6 ">
									...
									<div class="controls">
										<input type="text" name="censusAddress" value="${(member.censusAddress)!''}" class="m-wrap large" maxlength="200"/>
									</div>
								</div>
								<div class="control-group span6 ">
									<label class="control-label">详细现住址<span class="required">*</span></label>
									<div class="controls">
										<input type="text" name="liveAddress" value="${(member.liveAddress)!''}" class="m-wrap large" maxlength="200"/>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="control-group span6 ">
									...
									<div class="controls">
										<select name="mailAddress" id="mailAddress" data-value="${(member.mailAddress)!''}" class="m-wrap large">
											<option value="">请选择</option>
								...
								<div class="control-group span6 ">
									...
									<div class="controls">
										<input type="text" name="email" value="${(member.email)!''}" class="m-wrap large" maxlength="200"/>
									</div>
								</div>
							</div>
							<div class="row-fluid">
								<div class="control-group span6 ">
									...
									<div class="controls">
										<select name="liveProperty" class="m-wrap large" data-value="${(member.liveProperty)!''}">
											<option value="">请选择</option>
								...
								<div class="control-group span6 ">
									...
									<div class="controls">
										<select name="qualifiType" class="m-wrap large" data-value="${(member.qualifiType)!''}">
											<option value="">请选择</option>
							...
							<div class="row-fluid">
								<div class="control-group span6 ">
									...
									<div class="controls">
										<select name="maritalStatus" class="m-wrap large" data-value="${(member.maritalStatus)!''}">
											<option value="">请选择</option>
								...
								<div class="control-group span6 ">
									...
									<div class="controls">
										<select name="haveChild" class="m-wrap large" data-value="${(member.haveChild)!''}">
											<option value="">请选择</option>
							...
							<div class="row-fluid">
								<div class="control-group span6 ">
									...
									<div class="controls">
										<input type="number" name="haveLoan" value="${(member.haveLoan)!''}" class="m-wrap large" maxlength="8"/>
									</div>
								</div>
								<div class="control-group span6 ">
									<label class="control-label">现住址居住时长(年)<span class="required">*</span></label>
									<div class="controls">
										<input type="number" name="liveYears" value="${(member.liveYears)!''}" class="m-wrap large" max="100"/>
									</div>
								</div>
							</div>
